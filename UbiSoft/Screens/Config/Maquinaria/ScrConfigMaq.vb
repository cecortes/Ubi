...
#Region "Métodos"
    ...
    Private Sub CerrarFormPanel()
        ...
        For Each formulario As Form In Application.OpenForms
            ...
            If formulario.Name = "ScrConfigMaqNew" Then

                'Close
                ScrConfigMaqNew.Close()

            ElseIf formulario.Name = "ScrConfigMaqEdit" Then

                'Close
                ScrConfigMaqEdit.Close()

            ElseIf formulario.Name = "ScrConfigMaqDel" Then

                'Close
                ScrConfigMaqDel.Close()
...
#Region "Eventos"
    ...
    ''' Muestra el panel para agregar maquinaria
    ''' </summary>
    ...
    Private Sub BtnNew_Click(sender As Object, e As EventArgs) Handles BtnNew.Click
        ...
        'Open
        AbrirFormPanel(Of ScrConfigMaqNew)()

    End Sub

    ''' <summary>
    ''' Llama al método para cerrar los paneles
    ''' Muestra el panel para editar maquinaria
    ''' </summary>
    ''' <param name="sender"></param>
    ''' <param name="e"></param>
    Private Sub BtnEdit_Click(sender As Object, e As EventArgs) Handles BtnEdit.Click
        ...
        'Open
        AbrirFormPanel(Of ScrConfigMaqEdit)()

    End Sub

    ''' <summary>
    ''' Llama al método para cerrar los paneles
    ''' Muestra el panel para borrar maquinaria
    ''' </summary>
    ''' <param name="sender"></param>
    ''' <param name="e"></param>
    Private Sub BtnDel_Click(sender As Object, e As EventArgs) Handles BtnDel.Click
        ...
        'Open
        AbrirFormPanel(Of ScrConfigMaqDel)()
