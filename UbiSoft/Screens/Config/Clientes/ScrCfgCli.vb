...
#Region "Eventos"
    ...
    ''' Muestra el panel para agregar a los clientes
    ''' </summary>
    ...
    Private Sub BtnNew_Click(sender As Object, e As EventArgs) Handles BtnNew.Click
        ...
        'Open
        AbrirFormPanel(Of ScrConfigCliNew)()

    End Sub

    ''' <summary>
    ''' Llama al método para cerrar los paneles
    ''' Muestra el panel para editar a los clientes
    ''' </summary>
    ''' <param name="sender"></param>
    ''' <param name="e"></param>
    Private Sub BtnEdit_Click(sender As Object, e As EventArgs) Handles BtnEdit.Click
        ...
        'Open
        AbrirFormPanel(Of ScrConfigCliEdit)()

    End Sub

    ''' <summary>
    ''' Llama al método para cerrar los paneles
    ''' Muestra el panel para borrar a los clientes
    ''' </summary>
    ''' <param name="sender"></param>
    ''' <param name="e"></param>
    Private Sub BtnDel_Click(sender As Object, e As EventArgs) Handles BtnDel.Click
        ...
        'Open
        AbrirFormPanel(Of ScrConfigCliDel)()
