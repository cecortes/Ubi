...
#Region "Funciones y Métodos"
    ...
    Private Sub CerrarFormPanel()
        ...
        For Each formulario As Form In Application.OpenForms
            ...
            If formulario.Name = "ScrConfigPrimaNew" Then

                'Close
                ScrConfigPrimaNew.Close()

            ElseIf formulario.Name = "ScrConfigPrimaEdit" Then

                'Close
                ScrConfigPrimaEdit.Close()

            ElseIf formulario.Name = "ScrConfigPrimaDel" Then

                'Close
                ScrConfigPrimaDel.Close()
...
#Region "Eventos"
    ...
    ''' Muestra el panel para agregar materia prima
    ''' </summary>
    ...
    Private Sub BtnNew_Click(sender As Object, e As EventArgs) Handles BtnNew.Click
        ...
        'Open
        AbrirFormPanel(Of ScrConfigPrimaNew)()

    End Sub

    ''' <summary>
    ''' Llama al método para cerrar los paneles
    ''' Muestra el panel para editar materia prima
    ''' </summary>
    ''' <param name="sender"></param>
    ''' <param name="e"></param>
    Private Sub BtnEdit_Click(sender As Object, e As EventArgs) Handles BtnEdit.Click
        ...
        'Open
        AbrirFormPanel(Of ScrConfigPrimaEdit)()

    End Sub

    ''' <summary>
    ''' Llama al método para cerrar los paneles
    ''' Muestra el panel para borrar materia prima
    ''' </summary>
    ''' <param name="sender"></param>
    ''' <param name="e"></param>
    Private Sub BtnDel_Click(sender As Object, e As EventArgs) Handles BtnDel.Click
        ...
        'Open
        AbrirFormPanel(Of ScrConfigPrimaDel)()
