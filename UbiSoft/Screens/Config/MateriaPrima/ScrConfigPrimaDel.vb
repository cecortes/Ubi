...
Public Class ScrConfigPrimaDel
...
#Region "Funciones y Eventos"
    ...
    ''' <summary>
    ''' Captura el key prima_nombre de prima
    ''' Pasa la id a datos
    ''' Realiza el delete de la tabla prima
    ''' </summary>
    Private Sub DelPrimaData()

        'Captura
        datos.prima_nombre = TxtNom.Text

        'Delete 
        If (del.DelPrima(datos)) Then

            'Msg Usr
            MsgBox("Materia Prima eliminada", MsgBoxStyle.OkOnly, "UbiSoft by Ubicamatic - 2020(C)")
...
#Region "Eventos"
    ...
    ''' <param name="e"></param>
    Private Sub ScrConfigPrimaDel_Load(sender As Object, e As EventArgs) Handles Me.Load
